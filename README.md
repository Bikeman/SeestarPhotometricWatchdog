WORK IN PROGRESS.....STAY TUNED FOR THE FIRST BETA RELEASE PROBABLY IN ERALY APRIL 2025
...
For  ASTAP and its command line interface `astap_cli`, we need a newer version than the one provided by the "Bookworm" repository. I suggest to follow install instruction on `https://www.hnsky.org/astap.htm`
